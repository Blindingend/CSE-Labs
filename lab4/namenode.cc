...
{
	fprintf(stderr, "getblock %d woshilog\n", ino);
	fflush(stderr);
...
{
	fprintf(stderr, "complete %d %d woshilog\n", ino, new_size);
	fflush(stderr);
...
{
	fprintf(stderr, "appendblock %d woshilog\n", ino);
	fflush(stderr);
...
bool NameNode::Mkdir(yfs_client::inum parent, string name, mode_t mode, yfs_client::inum &ino_out)
{
	...
	// cout.flush();
	fprintf(stderr, "mkdir %s %d in %d woshilog\n", name.c_str(), ino_out);
	fflush(stderr);
...
bool NameNode::Create(yfs_client::inum parent, string name, mode_t mode, yfs_client::inum &ino_out)
{
	...
	// cout.flush();
	fprintf(stderr, "create %d %s %d woshilog\n", parent, name.c_str(), ino_out);
	fflush(stderr);
